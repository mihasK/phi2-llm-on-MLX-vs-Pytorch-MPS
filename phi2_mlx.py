#### Code (partially) taaken from 
#### https://github.com/ml-explore/mlx-examples/tree/main/llms/phi2
...
### Loading of pretrained phi-2 and converting weights to MLX-readable format 
...
def convert():
    model = AutoModelForCausalLM.from_pretrained(
        # "microsoft/phi-2", torch_dtype=torch.float32, trust_remote_code=True, device_map="cpu",
...
### END ---- Loading of pretrained phi-2 and converting weights to MLX-readable format



## PHI-2 model - MLX implementation 
@dataclass
class ModelArgs:
